...
# Output
my_output <- paste("../../Desktop/summaries/","busco_figure.png",sep="/") 
my_width <- 20
my_height <- 15
my_unit <- "cm"
...
my_species <- c('G_maculatum_Hap1_transcriptome', 'G_maculatum_Hap1_transcriptome', 'G_maculatum_Hap1_transcriptome', 'G_maculatum_Hap1_transcriptome', 'G_maculatum_Hap1', 'G_maculatum_Hap1', 'G_maculatum_Hap1', 'G_maculatum_Hap1', 'G_maculatum_Hap2', 'G_maculatum_Hap2', 'G_maculatum_Hap2', 'G_maculatum_Hap2', 'G_maculatum_Hap2_transcriptome', 'G_maculatum_Hap2_transcriptome', 'G_maculatum_Hap2_transcriptome', 'G_maculatum_Hap2_transcriptome')
...
my_percentage <- c(36.1, 56.3, 0.7, 6.9, 24.8, 69.9, 0.7, 4.6, 24.2, 70.4, 0.7, 4.7, 36.3, 55.7, 0.7, 7.3)
my_values <- c(840, 1309, 16, 161, 576, 1625, 17, 108, 563, 1637, 17, 109, 845, 1295, 16, 170)
