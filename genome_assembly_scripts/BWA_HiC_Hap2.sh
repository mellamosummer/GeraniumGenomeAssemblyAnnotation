...
bwa index -a bwtsw $HIFIASMDIR/G_maculatum_BF73.asm.hic.hap2.p_ctg.fa 

#Step 2: Perform the BWA alignment
bwa mem -t 24 -5SP \
    $HIFIASMDIR/G_maculatum_BF73.asm.hic.hap2.p_ctg.fa \
    $OMNICDIR/LAWR_OmniC_NA_NA_GAGACGAT_Geranium_maculatum_BF73-Geranium_maculatum_BF73_OmniC_I1420_L6_R1.fastq.gz \
    $OMNICDIR/LAWR_OmniC_NA_NA_GAGACGAT_Geranium_maculatum_BF73-Geranium_maculatum_BF73_OmniC_I1420_L6_R2.fastq.gz > $HIFIASMDIR/G_maculatum_BF73.asm.hic.hap2.p_ctg_vs_HiC.sam
