...
juicer pre \
    -a \
    -o $YAHSDIR/G_maculatum_BF73-hap1-JBAT \
    $YAHSDIR/G_maculatum_BF73-hap1.bin \
    $YAHSDIR/G_maculatum_BF73-hap1_scaffolds_final.agp \
    $HIFIASMDIR/G_maculatum_BF73.asm.hic.hap1.p_ctg.fa.fai > $YAHSDIR/G_maculatum_BF73-hap1-JBAT.log 2>&1
