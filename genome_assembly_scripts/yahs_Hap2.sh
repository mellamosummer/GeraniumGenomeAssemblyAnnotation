...
yahs -o $HIFIASMDIR/yahs/G_maculatum_BF73-hap2 $HIFIASMDIR/G_maculatum_BF73.asm.hic.hap2.p_ctg.fa $HIFIASMDIR/G_maculatum_BF73.asm.hic.hap2.p_ctg_vs_HiC.sorted.bam
