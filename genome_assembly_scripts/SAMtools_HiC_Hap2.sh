...
#run SAMtools
samtools view -h -b -F 2316 $HIFIASMDIR/G_maculatum_BF73.asm.hic.hap2.p_ctg_vs_HiC.sam > $HIFIASMDIR/G_maculatum_BF73.asm.hic.hap2.p_ctg_vs_HiC.bam
samtools sort -n $HIFIASMDIR/G_maculatum_BF73.asm.hic.hap2.p_ctg_vs_HiC.bam > $HIFIASMDIR/G_maculatum_BF73.asm.hic.hap2.p_ctg_vs_HiC.sorted.bam
