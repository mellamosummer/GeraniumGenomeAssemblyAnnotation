...
java -jar $EBROOTJUICEBOX/juicer_tools.2.20.00.jar pre \
      $YAHSDIR/G_maculatum_BF73-hap2-JBAT.txt $YAHSDIR/G_maculatum_BF73-hap2-JBAT.hic <(cat $YAHSDIR/G_maculatum_BF73-hap2-JBAT.log | grep PRE_C_SIZE | awk '{print $2" "$3}')
